        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParsedData = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Benefits = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobID = table.Column<int>(type: "INTEGER", nullable: false),
                    UserID = table.Column<string>(type: "TEXT", nullable: false),
                    ResumePath = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ...
                    EmployerNotes = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryID", "CategoryName", "Description", "DisplayOrder", "IsActive" },
                values: new object[,]
                {
                    { 1, "Software Development", "Programming and development jobs", 1, true },
                    { 2, "Web Development", "Frontend and backend web development", 2, true },
                    { 3, "Mobile Development", "iOS and Android app development", 3, true },
                    { 4, "Data Science", "Data analysis and machine learning", 4, true },
                    { 5, "DevOps", "Infrastructure and deployment", 5, true },
                    { 6, "UI/UX Design", "User interface and experience design", 6, true },
                    { 7, "Quality Assurance", "Testing and QA roles", 7, true },
                    { 8, "Project Management", "Project and product management", 8, true }
                });
